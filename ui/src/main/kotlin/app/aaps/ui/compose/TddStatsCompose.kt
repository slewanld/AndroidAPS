...
fun TddTableHeaderRow() {
    Row(
        ...
        Text(
            text = stringResource(app.aaps.core.ui.R.string.date),
            style = MaterialTheme.typography.labelMedium,
            fontWeight = FontWeight.Bold,
        ...
        Text(
            text = stringResource(app.aaps.core.ui.R.string.basalrate),
            style = MaterialTheme.typography.labelMedium,
            fontWeight = FontWeight.Bold,
        ...
        Text(
            text = stringResource(app.aaps.core.ui.R.string.bolus),
            style = MaterialTheme.typography.labelMedium,
            fontWeight = FontWeight.Bold,
            modifier = Modifier.weight(1f),
            textAlign = TextAlign.Center
        ...
        Text(
            text = stringResource(app.aaps.core.ui.R.string.tdd_total),
            style = MaterialTheme.typography.labelMedium,
            fontWeight = FontWeight.Bold,
            modifier = Modifier.weight(1f),
            textAlign = TextAlign.Center
        ...
        Text(
            text = stringResource(app.aaps.core.ui.R.string.carbs),
            style = MaterialTheme.typography.labelMedium,
            fontWeight = FontWeight.Bold,
            modifier = Modifier.weight(1f),
            textAlign = TextAlign.Center
